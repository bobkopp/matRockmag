...
%
% generates a Lowrie-Fuller or multi-AF demag plot for Rmg, where Rmg can be either an Rmg structure or an array of AFs.
%
...
for i=1:length(AF)
	plot(AF(i).treatmentAFFields*1000,AF(i).mzNormalized,[linecolors{mod(i,6)+1} linesyms{mod(i,11)+1} '-']);
	hold on;
